...
void main() {
  ...
  test(
      'updateHabit with EditScope.onlyThis creates new habit, series and exception',
      () async {
    ...
    // Save the habit with EditScope.onlyThis
    final updatedHabit =
        await controller.updateHabit(habit, () async => EditScope.onlyThis);
  ...
  test('updateHabit with EditScope.all updates series and original habit',
      () async {
    // Navigate to the habit detail screen
    final habit = await repository.getHabit(habitId);
    await controller.fromHabit(habit!);
    ...
    // Act: Call updateHabit with EditScope.all
    final updatedHabit =
        await controller.updateHabit(habit, () async => EditScope.all);
  ...
  test(
      'updateHabit with EditScope.thisAndFollowing creates trimmed old series and new series',
      () async {
    ...
    // Save the habit with EditScope.thisAndFollowing
    final updateHabit = await controller.updateHabit(
        habit, () async => EditScope.thisAndFollowing);
